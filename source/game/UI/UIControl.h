...
public:
     ...
     */
    void InitGroup(u32 count);

    /**
     * Set a child control in the control group.
     */
    void SetChild(u32 index, UIControl* control);

    /**
     * Get the amount of time to wait before transitioning after pressing the
     * button.
     */
    f32 GetSlideDelay();

    /**
     * Set the control group to which this control belongs to.
     */
    void SetGroup(ControlGroup* group, u32 drawPass);

    /**
     * Set the sounds for the slide transitions between pages.
     * @param forwardSound Sound that plays when the page transitions in.
     * @param backSound Sound that plays when the back button is pressed.
     */
...
public:
     ...
     * @param param_2 Unknown. Call with this set to 0.
     */
    void PlaySound(s32 sound, s32 param_2 = 0);
