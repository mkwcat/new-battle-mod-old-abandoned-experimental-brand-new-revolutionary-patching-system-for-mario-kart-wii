...
CHUNKS = {
    'E': [
        ...
        Chunk(0x802470a0, 0x802470a4, 0x80246d88),
        Chunk(0x80276054, 0x8027da98, 0x80271d14),
        Chunk(0x802a4080, 0x80384c18, 0x8029fd00),
        Chunk(0x80384f60, 0x80386644, 0x80380be0),
        ...
        Chunk(0x8086c988, 0x8086ca40, 0x80866b30),
        ...
        Chunk(0x80895238, 0x808952B8, 0x8088F940),
        Chunk(0x808913c0, 0x808913c4, 0x8088cf78),
        Chunk(0x808ad3c4, 0x808ad3c8, 0x808a7304),
        Chunk(0x808b2218, 0x808b225c, 0x808ade50),
        Chunk(0x808b3984, 0x808b3988, 0x808af134),
        Chunk(0x808b5b1c, 0x808b5b20, 0x808b125c),
        Chunk(0x808b5c78, 0x808b5c7c, 0x808b13b8),
        Chunk(0x808BB034, 0x808BB098, 0x808B4F3C),
        ...
        Chunk(0x808da070, 0x808da080, 0x808d3e50),
        Chunk(0x808da318, 0x808da368, 0x808d3f60),
        Chunk(0x808dc350, 0x808dc540, 0x808d8218),
        Chunk(0x809bd6e8, 0x809bd74c, 0x809b8f28),
        Chunk(0x809c1830, 0x809c1834, 0x809bd070),
        Chunk(0x809c1874, 0x809c1878, 0x809bd0b4),
        ...
        Chunk(0x809c282c, 0x809c2854, 0x809bdbec),
        Chunk(0x809c28b8, 0x809c28bc, 0x809be0f8),
        Chunk(0x809c2be8, 0x809c2bec, 0x809be398),
        Chunk(0x809c2ef0, 0x809c2ef4, 0x809be730),
        Chunk(0x809c2f38, 0x809c2f40, 0x809be740),
        Chunk(0x809c2f44, 0x809c2f48, 0x809be74c),
        Chunk(0x809c3618, 0x809c361c, 0x809bee20),
    ...
    'J': [
        ...
        Chunk(0x808913c0, 0x808913c4, 0x80890a10),
        Chunk(0x80895238, 0x808952B8, 0x80894888),
        Chunk(0x808ad3c4, 0x808ad3c8, 0x808ac524),
        Chunk(0x808b3984, 0x808b3988, 0x808b2ae4),
        Chunk(0x808b5b1c, 0x808b5b20, 0x808b4c7c),
        Chunk(0x808b5c78, 0x808b5c7c, 0x808b4dd8),
        Chunk(0x808BB034, 0x808BB098, 0x808BA184),
        ...
        Chunk(0x808da070, 0x808da080, 0x808d91c0),
        Chunk(0x808da318, 0x808da368, 0x808d9468),
        Chunk(0x809bd6e8, 0x809bd74c, 0x809bc748),
        Chunk(0x809c1830, 0x809c1834, 0x809c0890),
        Chunk(0x809c1874, 0x809c1878, 0x809c08d4),
        ...
        Chunk(0x809c282c, 0x809c2854, 0x809c188c),
        Chunk(0x809c28b8, 0x809c28bc, 0x809c1918),
        Chunk(0x809c2be8, 0x809c2bec, 0x809c1c48),
        Chunk(0x809c2ef0, 0x809c2ef4, 0x809c1f50),
        Chunk(0x809c2f38, 0x809c2f40, 0x809c1f98),
        Chunk(0x809c2f44, 0x809c2f48, 0x809C1FA4),
        Chunk(0x809c3618, 0x809c361c, 0x809c2678),
    ...
    'K': [
        ...
        Chunk(0x808913c0, 0x808913c4, 0x8087f7c8),
        Chunk(0x80895238, 0x808952B8, 0x80883648),
        Chunk(0x808ad3c4, 0x808ad3c8, 0x8089b824),
        Chunk(0x808b3984, 0x808b3988, 0x808a1dfc),
        Chunk(0x808b5b1c, 0x808b5b20, 0x808a3f94),
        Chunk(0x808b5c78, 0x808b5c7c, 0x808a40f0),
        Chunk(0x808BB034, 0x808BB098, 0x808A94A4),
        ...
        Chunk(0x808da070, 0x808da080, 0x808c8508),
        Chunk(0x808da318, 0x808da368, 0x808c87b0),
        Chunk(0x809bd6e8, 0x809bd74c, 0x809abd28),
        Chunk(0x809c1830, 0x809c1834, 0x809afe70),
        Chunk(0x809c1874, 0x809c1878, 0x809afeb4),
        ...
        Chunk(0x809c282c, 0x809c2854, 0x809b0e6c),
        Chunk(0x809c28b8, 0x809c28bc, 0x809b0ef8),
        Chunk(0x809c2be8, 0x809c2bec, 0x809b1228),
        Chunk(0x809c2ef0, 0x809c2ef4, 0x809b1530),
        Chunk(0x809c2f38, 0x809c2f40, 0x809b1578),
        Chunk(0x809c2f44, 0x809c2f48, 0x809B1584),
        Chunk(0x809c3618, 0x809c361c, 0x809b1c58),
...
parser.add_argument('in_rel')
parser.add_argument('out_rel')
...
with open(args.in_rel, 'rb') as in_rel_file:
    in_rel_data = in_rel_file.read()

out_rel_data = bytearray(in_rel_data)

import_table_offset = struct.unpack('>I', in_rel_data[0x28:0x2C])[0]
import_table_size = struct.unpack('>I', in_rel_data[0x2C:0x30])[0]

for i in range(int(import_table_size / 8)):
    entry_offset = import_table_offset + i * 8
    module_num, rel_offset = struct.unpack('>II', in_rel_data[entry_offset:entry_offset+8])

    if module_num != 0:
        continue

    while in_rel_data[rel_offset + 2] != 203:
        if in_rel_data[rel_offset + 2] < 200 and in_rel_data[rel_offset + 2] != 0:
            addend = struct.unpack('>I', in_rel_data[rel_offset + 4:rel_offset + 8])[0]

            address = port(args.region, addend)
            if address is None:
                sys.exit(f'Couldn\'t port symbol {addend:08X} to region {args.region}!')

            out_rel_data[rel_offset + 4:rel_offset + 8] = struct.pack('>I', address)
        rel_offset += 8

with open(args.out_rel, 'wb') as out_file:
    out_file.write(out_rel_data)
