...
public:
    ...
    enum {
        ...
        FLAGS4_UNKNOWN_4_5 = (1 << 5), // 0x20
        FLAGS4_GHOST = (1 << 6), // 0x40
        FLAGS4_UNKNOWN_4_7 = (1 << 7), // 0x80
        FLAGS4_UNKNOWN_4_8 = (1 << 8), // 0x100
        FLAGS4_UNKNOWN_4_9 = (1 << 9), // 0x200
        FLAGS4_UNKNOWN_4_10 = (1 << 10), // 0x400
        FLAGS4_UNKNOWN_4_11 = (1 << 11), // 0x800
        FLAGS4_HAS_STOPPED = (1 << 12), // 0x1000
        FLAGS4_UNKNOWN_4_13 = (1 << 13), // 0x2000
        FLAGS4_UNKNOWN_4_14 = (1 << 14), // 0x4000
        FLAGS4_UNKNOWN_4_15 = (1 << 15), // 0x8000
        FLAGS4_BATTLE_SIDELINE = (1 << 16), // 0x10000
        FLAGS4_BATTLE_RESPAWN = (1 << 17), // 0x20000
